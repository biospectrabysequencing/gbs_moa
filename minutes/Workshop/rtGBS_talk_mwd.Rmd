...
* Developed new GBS wet bench protocol in Plant and Food
...
* *stdGBS* versus *rtGBS*
* Interested in *sample* variability 
...
* Forward AND/OR reverse complement reads

<image src="images/ensembl.jpg" width="750px"/>

* Find *Tag* sites in 192 Bam files

<font size=3 color="blue">$ perl gbsSites.pl -out [OUTFILE.txt] [BAM FILES]</font>
```
...
* Depth $\ge 10$ for detecting SNPs
...
## BamHI sites in Kiwifruit genome                           <!-- slide 7 -->


* 79,511 sites match BamHI GGATCC in reference genome  

<image src="images/Population_fragments.png" height="350px" />

Fragment size distribution $X \sim exp(\lambda)$ 


## Fragment distributions                            <!-- slide 8 -->
...
$\rightarrow$ stdGBS distribution *bimodal*


## Fragment Quantiles vs Population                         <!-- slide 9 -->
...
## Sample Tags versus Population                       <!-- slide 12 -->
...
* SNPs in restriction sites 2185 *stdGBS*, 10540 *rtGBS*
